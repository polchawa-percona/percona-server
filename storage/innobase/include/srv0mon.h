...
enum monitor_id_t {
  ...
  /* Clock-sweep PoC replacement-policy counters. */
  MONITOR_CLOCK_SWEEP_EXAMINED,
  MONITOR_CLOCK_SWEEP_EXAMINED_NUM_CALL,
  MONITOR_CLOCK_SWEEP_EXAMINED_PER_CALL,
  MONITOR_CLOCK_SWEEP_DECREMENTED,
  MONITOR_CLOCK_SWEEP_EVICTED,
  MONITOR_CLOCK_SWEEP_GIVEUP,
  MONITOR_CLOCK_SWEEP_LRU_MTX_US,
